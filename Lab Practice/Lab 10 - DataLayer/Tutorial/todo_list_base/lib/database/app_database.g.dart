  ...
  Future<sqflite.Database> open(
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        ...
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `todos` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `title` TEXT NOT NULL, `status` TEXT NOT NULL, `priority` TEXT NOT NULL, `date` TEXT NOT NULL, `time` TEXT NOT NULL, `pid` INTEGER NOT NULL, FOREIGN KEY (`pid`) REFERENCES `projects` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE)');
...
class _$ProjectDao extends ProjectDao {
  ...
  @override
  Future<Project?> findProjectById(int id) async {
